...
let defaultTexts = [
    {
        textValue: `На узліссі стоїть самотній дуб. Міцний, кремезний. Старий, мов дід-пастух. Мабуть, і виріс він на узліссі, щоб бачити, як ростуть його побратими в лісі.
        Та ось налетіла гроза. Вдарила вогняна стріла у стовбур дуба. Затремтіли гілки. Загорілось вер-ховіття. Лив дощ, а дуб горів — аж палахкотів... Обгоріла його вершина. Засумував ліс — хто ж тепер буде нашим пастухом? 
       Але дуб не загинув. Через рік зазеленіли молоді пагони, де обгоріли гілки. Вкрився старий дуб кучерявим листям. А вершина була суха. Летіли з теплого краю лелеки. Бачать — сухе верховіття. Сіли на нього й змостили там гніздо. Зрадів старий дуб. Тепер він не самотній. Коли заходить сон-це, лелека стоїть у гнізді на одній нозі й дивиться кудись далеко-далеко. Туди, де сховалося соне- чко. Це він видивляється, чи не буде часом грози. Спокійно стоїть лелека. І дуб зітхає спокійно. Зашумить зеленим листям і засинає.
       `,
        category: 'Дорослі',
        questions: [
            {
